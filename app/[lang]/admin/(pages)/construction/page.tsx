...
import { Construction, Cpu, Rocket, ArrowLeft, ShieldCheck } from 'lucide-react';
        ...
        <div className="min-h-[80vh] flex flex-col items-center justify-center p-6 text-center">
            ...
            <div className="max-w-xl space-y-4">
                <h1 className="text-4xl md:text-5xl font-black uppercase tracking-tighter text-white">
                    Module en <span className="text-primary">Développement</span>
                </h1>
                
                <p className="text-slate-400 text-sm leading-relaxed font-medium">
                    Cette section du panneau d'administration est en cours d'optimisation. 
                    Nous finalisons l'architecture de données pour garantir une gestion fluide 
                    et sécurisée de vos contenus **ICPRD**.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-12 w-full max-w-2xl">
                {[
                    { icon: <ShieldCheck size={18} />, label: "SÉCURITÉ", status: "Validée" },
                    { icon: <Construction size={18} />, label: "INTERFACE", status: "85%" },
                    { icon: <Rocket size={18} />, label: "DÉPLOIEMENT", status: "Bientôt" },
                ].map((item, i) => (
                    <div key={i} className="p-4 bg-white/[0.02] border border-white/5 rounded-2xl flex flex-col items-center gap-2">
