        ...
        <div className="min-h-screen bg-background p-10 font-sans">
            ...
            <div className="flex justify-between items-start mb-10">
                ...
                <button
                    ...
                    className="group flex items-center gap-3 bg-primary text-white px-6 py-3 font-bold rounded-full hover:pr-8 transition-all duration-300 cursor-pointer"
                >
                    <Plus
                        size={20}
            ...
            {!isLoading && achievementsData.length == 0 ? (
                <EmptyState
                    ...
                    description="
                            ...
                            parcours."
                    link="/admin/achievements/new"
                    copy="Créez votre prémière réalisation"
                    icon={<Trophy strokeWidth={1.5} size={32} />}
                />
            ) : (
                <>
                    {/* Main Card */}
