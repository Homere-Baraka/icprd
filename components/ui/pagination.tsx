        ...
        <nav className="w-full max-w-7xl mx-auto mt-16 mb-10 px-4">
            <div className="flex items-center justify-end gap-10 py-6 border-t border-white/5">
                ...
                >
                    ...
                    <span className="text-[11px] font-black uppercase tracking-widest">Précédent</span>
                </button>
                ...
                <div className="hidden md:flex items-center gap-2">
                    {pages.map((page) => (
                        ...
                        onClick={() => {
                            ...
                            if (diff < 0) for(let i=0; i<Math.abs(diff); i++) onBack();
                        }}
                        >
                            {page + 1}
                        </button>
                ...
                <div className="md:hidden flex flex-col items-center">
                    <span className="text-[10px] font-black text-primary uppercase tracking-[0.2em]">
                        Page {currentIndex + 1} <span className="text-slate-600 mx-1">/</span> {totalCount}
                    </span>
                </div>
                ...
                >
                    <span className="text-[11px] font-black uppercase tracking-widest">Suivant</span>
